...
blob_name = 'raw/new-york-city-taxi-fare-prediction/train_100_registers.csv'  # Nome do arquivo que você quer ler
...
with open("train_100_registers.csv", "wb") as my_blob:
...
with open("train_100_registers.csv", "r") as csvfile:
...
print(f"Dados do arquivo train_100_registers.csv enviados para o Kafka com sucesso!")
